  ...
  const planNewJourney = async ({ origin, destination, stops = [], traveler = null }) => {
    ...
    try {
      ...
      const allStops = [
        {
          ...
          lat: origin.lat || 18.9220,
          lng: origin.lng || 72.8347,
          day: 1,
          arrivalTime: '09:00',
          departureTime: '09:30',
        ...
        ...stops.map((s, idx) => ({
          ...
          lat: s.lat || 18.9300 + idx * 0.01,
          lng: s.lng || 72.8300 + idx * 0.01,
          day: s.day || 1,
        ...
        })),
        {
          ...
          type: 'stay',
          city: destination.name?.split(',')[0] || 'Destination',
          lat: destination.lat || 18.9432,
          lng: destination.lng || 72.8230,
          day: 1,
          arrivalTime: '17:00',
          departureTime: '19:00',
      ...
      const segment1 = {
        ...
        originId: 'stop-1',
        originLat: origin.lat || 18.9220,
        originLng: origin.lng || 72.8347,
        destination: destination.name || 'Destination',
        destinationId: `stop-${allStops.length}`,
        destinationLat: destination.lat || 18.9432,
        destinationLng: destination.lng || 72.8230,
        status: 'ACTIVE',
        candidateRoutes,
